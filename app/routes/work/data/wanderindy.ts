export const wanderIndyProject = {
  id: "wanderindy",
  ...
  media: [
    ...
    { name: "Course Project", url: "#" }
  ],
  hasVideo: false,
  images: [
    "/images/wanderindy/hero.png",
    "/images/wanderindy/stamps.png",
    "/images/wanderindy/kiosk-design.png",
    "/images/wanderindy/design-evolution.png",
  ...
  sections: [
    ...
    },
    {
      ...
      content: "From paper prototypes to mid-fi structures to high-fidelity polish, we iterated constantly. I designed the kiosk interface and interaction flows, ensuring the vertical format supported intuitive navigation.\n\nWe developed a full design system: Urbanist typography, color-coded trails (Food: Warm Coral, Art: Indigo Purple, Museums: Deep Teal, Shopping: Soft Gold), and hand-drawn doodles that added personality without overwhelming the minimal aesthetic",
      visual: "/images/wanderindy/design-evolution.png"
    },
    {
