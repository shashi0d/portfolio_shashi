  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900">
      ...
      <Section delay={0.1}>
        <div className="px-6 md:px-10 mb-24">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              <h3 className="text-2xl md:text-3xl font-medium text-gray-900 dark:text-gray-100 mb-6">Building the System</h3>
        ...
        <div className="px-6 md:px-10 mb-24">
          <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="order-1 lg:order-2">
              <h3 className="text-2xl md:text-3xl font-medium text-gray-900 dark:text-gray-100 mb-6">Choosing the Right Stimuli</h3>
              <div className="space-y-4 text-lg text-gray-700 dark:text-gray-300 leading-relaxed">
                <p>
      ...
      <Section delay={0.1}>
        <div className="px-6 md:px-10 mb-24 bg-gray-50 dark:bg-gray-800 py-16">
          <div className="max-w-5xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-medium text-gray-900 dark:text-gray-100 mb-8">The Data Collection</h3>
      ...
      <Section delay={0.1}>
        <div className="px-6 md:px-10 mb-24">
          <div className="max-w-5xl mx-auto">
            <h3 className="text-2xl md:text-3xl font-medium text-gray-900 dark:text-gray-100 mb-8">Multi-Modal Data Foundation</h3>
            <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="p-6 border border-gray-200 rounded-xl">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Frame-Based Classification</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">Using CNNs on avatar images</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Time-Series Modeling</h4>
                <p className="text-sm text-gray-600 dark:text-gray-400">LSTM approaches on AU vectors</p>
              </div>
              <div className="p-6 border border-gray-200 rounded-xl">
                <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-2">Multi-Modal Fusion</h4>
        ...
        <div className="px-6 md:px-10 mb-24" style={{ backgroundColor: `${accentColor}10` }}>
          <div className="max-w-5xl mx-auto py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              <div>
                <div className="text-5xl font-medium text-gray-900 dark:text-gray-100 mb-2">30/50</div>
                <div className="text-lg text-gray-600 dark:text-gray-400">Participants Completed</div>
              </div>
              <div>
                <div className="text-5xl font-medium text-gray-900 dark:text-gray-100 mb-2">~54,000</div>
                <div className="text-lg text-gray-600 dark:text-gray-400">Data Points per Session</div>
              </div>
              <div>
                <div className="text-5xl font-medium text-gray-900 dark:text-gray-100 mb-2">63</div>
