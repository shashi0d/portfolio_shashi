          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6 pt-8 border-t border-gray-200">
              <div>
                ...
                <p className="text-gray-900 font-medium">Graduate Research Assistant at SETH Lab, Indiana University</p>
              </div>

              <div>
                <span className="text-gray-500 text-sm">Previously</span>
                <p className="text-gray-900 font-medium">Lead Full Stack Developer at Zero Distance Metaverse (2022–2024)</p>
              </div>

              <div>
                <span className="text-gray-500 text-sm">Education</span>
                <div className="space-y-2">
                  <p className="text-gray-900 font-medium">M.S., Human Computer Interaction – Indiana University (Expected May 2026)</p>
                  <p className="text-gray-900 font-medium">B.E., Computer Science and Engineering – Visvesvaraya Technological University (2020)</p>
                </div>
              </div>
            </div>
          </div>
