      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Link
              to="/"
              className="text-base md:text-lg font-medium text-gray-900 hover:text-gray-700 transition-colors"
              onClick={() => setMobileMenuOpen(false)}
            >
              <span className="hidden sm:inline">SHASHIDHARA NARAYANAPPA</span>
              <span className="sm:hidden">SHASHI N</span>
            </Link>
            <div className="w-2 h-2 bg-black rounded-full hidden sm:block"></div>
          </div>
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && (
          <nav className="md:hidden mt-4 pb-4 pt-2 border-t border-gray-100">
